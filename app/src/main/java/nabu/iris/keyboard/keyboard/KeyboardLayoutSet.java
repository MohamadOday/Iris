...
import nabu.iris.keyboard.keyboard.internal.KeyboardBuilder;
import nabu.iris.keyboard.keyboard.internal.KeyboardParams;
import nabu.iris.keyboard.keyboard.internal.UniqueKeysCache;
import nabu.iris.keyboard.latin.Subtype;
import nabu.iris.keyboard.latin.utils.InputTypeUtils;
import nabu.iris.keyboard.latin.utils.XmlParseUtils;
...
public final class KeyboardLayoutSet {
    ...
    public static void clearKeyboardLayoutSetCache() {
        for (int i = 0; i < sForcibleKeyboardCache.length; i++) {
