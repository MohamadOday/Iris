...
import nabu.iris.keyboard.keyboard.KeyboardLayoutSet.KeyboardLayoutSetException;
import nabu.iris.keyboard.keyboard.internal.KeyboardState;
import nabu.iris.keyboard.keyboard.internal.KeyboardTextsSet;
import nabu.iris.keyboard.latin.InputView;
import nabu.iris.keyboard.latin.LatinIME;
...
import nabu.iris.keyboard.latin.utils.CapsModeUtils;
import nabu.iris.keyboard.latin.utils.LanguageOnSpacebarUtils;
import nabu.iris.keyboard.latin.utils.RecapitalizeStatus;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    private void setMainKeyboardFrame(
            final SettingsValues settingsValues,
            final KeyboardSwitchState toggleState) {
        if (mLatinIME != null && mLatinIME.isKeyboardReplacingPanelOpen()) {
