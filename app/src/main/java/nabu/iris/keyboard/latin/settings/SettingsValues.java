...
public class SettingsValues {
    ...
    public final boolean mUtilityShowKeys;
    public final boolean mUtilityShowClipboard;
    public final boolean mUtilityShowAi;
    public final boolean mUtilityShowSettings;
    public final String mUtilityButtonOrder;
    ...
    public final String mSoundpackName;
    ...
    public SettingsValues(final SharedPreferences prefs, final Resources res,
        ...
        mSoundpackName = Settings.readKeyboardSoundpack(prefs);
        ...
        mEmojiList = Settings.readEmojiList(prefs);
        mUtilityShowKeys = Settings.readUtilityShowKeys(prefs);
        mUtilityShowClipboard = Settings.readUtilityShowClipboard(prefs);
        mUtilityShowAi = Settings.readUtilityShowAi(prefs);
        mUtilityShowSettings = Settings.readUtilityShowSettings(prefs);
        mUtilityButtonOrder = Settings.readUtilityButtonOrder(prefs);
    }
